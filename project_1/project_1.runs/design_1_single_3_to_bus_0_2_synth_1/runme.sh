...
HD_PWD='D:/coding/computer_organization/exp2nd/micro/project_1/project_1.runs/design_1_single_3_to_bus_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_single_3_to_bus_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_single_3_to_bus_0_2.tcl
