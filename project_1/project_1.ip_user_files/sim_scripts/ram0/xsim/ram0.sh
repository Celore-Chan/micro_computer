...
#
# Script generated by Vivado on Sat Nov 22 20:19:34 +0800 2025
...
#
# Usage        : ram0.sh
#                ram0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ram0.sh [-reset_run]
#                ram0.sh [-reset_log]
#                ram0.sh [-help]
#
...
export RDI_DATADIR="E:/Xilinx/Vivado/2024.2/data"

# set xvlog options
xvlog_opts="--incr --relax "

# script info
echo -e "ram0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ram0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ram0 xil_defaultlib.ram0 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/Xilinx/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ram0.wdb xsim.dir libdpi.so)
...
Usage: ram0.sh [-reset_log]\n\
Usage: ram0.sh [-keep_index]\n\
