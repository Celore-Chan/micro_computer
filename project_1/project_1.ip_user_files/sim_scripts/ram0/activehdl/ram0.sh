...
#                script (type 'ram0.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/coding/computer_organization/exp2nd/micro/project_1/project_1.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
