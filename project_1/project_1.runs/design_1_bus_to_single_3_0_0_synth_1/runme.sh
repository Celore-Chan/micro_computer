...
HD_PWD='D:/coding/computer_organization/exp2nd/micro/project_1/project_1.runs/design_1_bus_to_single_3_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_bus_to_single_3_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_bus_to_single_3_0_0.tcl
